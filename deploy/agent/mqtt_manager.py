    ...
    def _make_client(self, printer: PrinterCfg) -> mqtt.Client:
        ...
        def on_message(cl, userdata, msg):
            try:
                ...
                nozzle_temp = _safe_float(pr.get("nozzle_temper"))
                nozzle_target_temp = _safe_float(pr.get("nozzle_target_temper"))
                bed_temp = _safe_float(pr.get("bed_temper"))
                bed_target_temp = _safe_float(pr.get("bed_target_temper"))
                ...
                if not _has_value(nozzle_temp):
                    nozzle_temp = previous.get("nozzle_temp")
                if not _has_value(nozzle_target_temp):
                    nozzle_target_temp = previous.get("nozzle_target_temp")
                if not _has_value(bed_temp):
                    bed_temp = previous.get("bed_temp")
                if not _has_value(bed_target_temp):
                    bed_target_temp = previous.get("bed_target_temp")
